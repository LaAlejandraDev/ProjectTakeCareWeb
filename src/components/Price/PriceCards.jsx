export default function PriceCard({ name, cost, children, onSubscribe }) {
  return (
    <>
      <div className={"card w-96 shadow-sm border border-1 " + (cost >0? "bg-indigo-400 border-indigo-400 text-white" : "bg-base-100 border-gray-200") }>
        <div className="card-body">
          ...
          <div className="mt-6">
            <button className="btn btn-primary btn-block" onClick={() => onSubscribe()}>Subscribirse</button>
          </div>
        </div>
      </div>
    </>
